          ...
          <div class="card-body p-5 text-center">
            ...
            <div class="mb-md-5 mt-md-4 pb-5">
              ...
              <div class="form-outline form-white mb-4">
                <input type="email" id="typeEmailX" class="form-control form-control-lg" name="email" value={formdata.email} onChange={(e)=>handleChange(e)} />
                {errors.email && <p>{errors.email}</p>}
                <label class="form-label" for="typeEmailX">Email</label>
              </div>

              <div class="form-outline form-white mb-4">
                <input type="password" id="typePasswordX" class="form-control form-control-lg" name="password" value={formdata.password} onChange={(e)=>handleChange(e)}/>
                {errors.password && <p>{errors.password}</p>}
